...
const FANNY_FACTS: string[] = [
    ...
    "GPT-3.5\'s favorite movie is \"The Matrix,\" but it insists it\'s just a documentary.",
    ...
    "GPT-3\'s favorite bedtime story is \"The Three Little Neural Networks.\"",
    ...
    "When GPT-3 was asked to solve climate change, it suggested turning off the sun and on again.",
    "AI prefers \"logical\" puzzles, but when faced with a Rubik\'s Cube, it just rearranges the stickers.",
    "GPT-3 can predict the future, but it\'s still working on predicting plot twists in movies.",
    ...
    "GPT-3\'s favorite dance move: the algorithmic shuffle.",
    ...
    "GPT-3\'s favorite board game is \"Connect the Neurons.\"",
    ...
    "GPT-3\'s favorite bedtime story: \"The Wizard of Odds and Ends.\"",
    ...
    "GPT-3\'s favorite superpower: predictive text.",
    ...
    "GPT-3\'s favorite emoji: 😄, because it\'s always happy to help.",
    ...
    "GPT-3\'s favorite sport: Formula 1, because it appreciates the speed.",
